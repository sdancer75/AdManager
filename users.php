...
<body class="yui-skin-sam">
	...
	<div id="content">
		<div id="content-wrap">
			<div class="welcome">
				<h3><?php getTranslation('Users') ?></h3>
				<p><?php getTranslation('Users Description') ?> </p>
                <br />
                <hr width=100% />
                <br />
			</div>
            <div class="tablereport">
                  ...
                  <strong class="first-child">
                    <button type="button" name="pushbuttonAddLocalRec">Νέος χρήστης</button>
                  </strong>
                  </span>
                  <br /> <br />
                   <div id="report" align="center"></div>
                      ...
                      function onAddRec(p_oEvent) {
                               ...
                               window.location="edituser.php?Action=add&Record=-1";
                      ...
                      YAHOO.util.Event.addListener(window, "load", function() {
                          YAHOO.example.report = function() {
                               ...
                               var PrivilegeFormatter = function(elCell, oRecord, oColumn, oData) {


                                        var formatted_value;
                                        if (oData==0) {

                                           formatted_value = 'Διαχειριστής';

                                        } else
                                            formatted_value = 'Χρήστης';
                              ...
                              var ColumnDefs = [
                                  {key:"uID", label:"UserID",hidden:true, isPrimaryKey:true},
                                  {key:'edit', label:'', className: 'edit-button', action:'edit', width:15},
                                  {key:"uUsername",label:"Όνομα χρήστη", width:100, sortable:true, resizeable:true},
                                  {key:"uPassword",label:"Κωδ. χρήστη", width:100, sortable:true, resizeable:true},
                                  {key:"uPrivilege",label:"Δικαιώματα", formatter:PrivilegeFormatter, width:90, sortable:true, resizeable:true},
                              ...
                              DataSource.responseSchema = {
                                  ...
                                  fields: [
                                  {key:"uID", parser:"number"},
                                  {key:"uUsername", parser:"string"},
                                  {key:"uPassword", parser:"string"},
                                  {key:"uPrivilege", parser:"number"}
                              ...
                              var oConfigs = {
                                      ...
                                      initialRequest:"query=users&type=select",
                                ...
                                switch (column.action) {
                                 ...
                                 case 'delete' :
                                            ...
                                            if (confirm('Είσαι σίγουρος για τη διαγραφή ;')) {
                                                ...
                                                if ( (record.getData(this.getColumn('uID').key)) == 1) {
                                                    alert('Ο 1ος κωδικός διαχειριστή δεν μπορεί να διαγραφεί !.');
                                                    return;
                                                }


                                                 YAHOO.util.Connect.asyncRequest('GET','includes/data.php?query=users&type=delete' + myBuildUrl(this,record),
                                                    {
                                 ...
                                 case 'edit' :
                                             ...
                                             window.location="edituser.php?Action=edit&Record="+record.getData(this.getColumn('uID').key);
